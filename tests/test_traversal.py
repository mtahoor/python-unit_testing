...
class TestRouteMethods(unittest.TestCase):
    ...
    def test_example(self):
        ...
        self.assertListEqual(tw.computers, [self.top_top])
        self.assertListEqual(bw.computers, [self.bot_one])
        self.assertListEqual(lw.computers, [self.top_bot])
    ...
    def test_risk_adverse_virus(self):
        ...
        self.assertListEqual(rav.computers, [self.l_f,self.l_b1])
    ...
    def test_fancy_virus(self):
        ...
        self.assertListEqual(fv.computers, [self.top_top])
